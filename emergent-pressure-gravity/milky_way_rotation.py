...
Pressure-Field Gravity vs Newtonian Gravity

This script computes and compares rotation curves for the Milky Way
using standard Newtonian gravity (baryons only) and the proposed
pressure-field gravity framework.
"""
